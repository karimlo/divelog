<template>
    ...
    <div class="flex space-2 items-center border-b-2 pb-4">
      ...
      <div class="ml-3">
        <h1 class="text-3xl font-bold text-indigo-600">DIVES</h1>
        <p class="text-center text-sm text-indigo-600 mt-1 font-serif">LOG BOOK</p>
      </div>
    </div>
    <div class="flex items-center space-x-4 mt-6 p-2 bg-indigo-600 rounded-md">
      ...
      <div>
        <p class="text-lg text-white font-semibold">Dives</p>
      </div>
    </div>
    <div class="mt-8">
      <ul class="space-y-10">
